...
function V(e, n, t) {
  if (n.prevToken == "variable" || n.prevToken == "type" || /\S(?:[^- ]>|[*\]])\s*$|\*$/.test(e.string.slice(0, t)) || n.typeAtEndOfLine && e.column() == e.indentation())
    return !0;
}
function P(e) {
  for (; ; ) {
  ...
  function K(i, a) {
    ...
    if (i.eatWhile(B), F)
      for (; i.match(F); )
        i.eatWhile(B);
    var u = i.current();
    return k(l, u) ? (k(b, u) && (p = "newstatement"), k(_, u) && (E = !0), "keyword") : k(s, u) ? "type" : k(d, u) || U && U(u) ? (k(b, u) && (p = "newstatement"), "builtin") : k(w, u) ? "atom" : "variable";
  }
  function ce(i) {
    return function(a, c) {
...
function r(e) {
  for (var n = {}, t = e.split(" "), l = 0; l < t.length; ++l)
    n[t[l]] = !0;
  return n;
}
function k(e, n) {
