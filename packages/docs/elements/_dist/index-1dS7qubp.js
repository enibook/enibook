import { E as m, L as w, a as v } from "./index-r15drT3X.js";
import { s as z, t as o, e as k, L as x, b as T, d as W, f as R, j as U, a as Y, I as q, B as _ } from "./enibook-UgUmBc-f.js";
const E = 99, S = 1, Z = 100, C = 101, g = 2, y = [
  ...
  8287,
  12288
], G = 58, V = 40, P = 95, N = 91, Q = 45, j = 46, D = 35, I = 37, B = 38, F = 92, K = 10;
function d(e) {
...
const A = new m((e, t) => {
  for (let l = !1, a = 0, O = 0; ; O++) {
    ...
    if (d(r) || r == Q || r == P || l && L(r))
      ...
      l && e.acceptToken(r == V ? Z : a == 2 && t.canShift(g) ? g : C);
      break;
    }
  }
}), J = new m((e) => {
  if (y.includes(e.peek(-1))) {
    let { next: t } = e;
    (d(t) || t == P || t == D || t == j || t == N || t == G && d(e.peek(1)) || t == Q || t == B) && e.acceptToken(E);
  }
}), H = new m((e) => {
  if (!y.includes(e.peek(-1))) {
    let { next: t } = e;
