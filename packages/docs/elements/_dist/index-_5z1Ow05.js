import { C as Z, E as k, s as N, t as $, L as Y, a as A, i as I, b as j, k as U, g as z, l as q } from "./enibook-p00SynG0.js";
...
const re = W(J, "-->"), le = W(H, "?>"), oe = W(L, "]]>"), se = N({
  Text: $.content,
...
function me(e, t) {
  ...
  for (let l of t) {
    let g = E(l);
    n.push(g), l.global && O.push(g), l.values && (a[l.name] = l.values.map(G));
  }
  let r = [], i = [], p = /* @__PURE__ */ Object.create(null);
  for (let l of e) {
    let g = O, o = a;
    l.attributes && (g = g.concat(l.attributes.map((m) => typeof m == "string" ? n.find((f) => f.label == m) || { label: m, type: "property" } : (m.values && (o == a && (o = Object.create(o)), o[m.name] = m.values.map(G)), E(m)))));
    let S = new ge(l, g, o);
    p[S.name] = S, r.push(S), l.top && i.push(S);
  }
  i.length || (i = r);
  ...
  return (l) => {
    ...
    if (m == "openTag") {
      ...
      return s ? {
        ...
        options: [((g = p[s]) === null || g === void 0 ? void 0 : g.closeNameCompletion) || { label: s + ">", type: "type" }],
        validFor: C
      } : null;
    } else if (m == "attrName") {
      let s = p[T(o, u)];
      ...
      if (!s)
        return null;
      let y = p[T(o, u)], c = ((y == null ? void 0 : y.attrValues) || a)[s];
      ...
      let s = _(o, u), y = p[s], c = [], P = u && u.lastChild;
      s && (!P || P.name != "CloseTag" || T(o, P) != s) && c.push(y ? y.closeCompletion : { label: "</" + s + ">", type: "type", boost: 2 });
      let V = c.concat(((y == null ? void 0 : y.children) || (u ? r : i)).map((d) => d.openCompletion));
      if (u && (y != null && y.text.length)) {
        let d = u.firstChild;
...
function Se(e = {}) {
  return new z(R, R.data.of({
    autocomplete: me(e.elements || [], e.attributes || [])
  }));
}
export {
  me as completeFromSchema,
  Se as xml,
  R as xmlLanguage
};
