import { L as P, a as q, s as g, t as r, p as s } from "./enibook-UgUmBc-f.js";
import { html as c } from "./index-XUlAgx25.js";
import { javascriptLanguage as i } from "./index-w4kSYKUo.js";
import { L as R, E as p } from "./index-r15drT3X.js";
import "./index-1dS7qubp.js";
...
const d = /* @__PURE__ */ n(39, $, !1), f = /* @__PURE__ */ n(34, m, !1), C = /* @__PURE__ */ n(39, v, !0), T = /* @__PURE__ */ n(34, x, !0), A = /* @__PURE__ */ R.deserialize({
  ...
  wrap: /* @__PURE__ */ s((O, t) => O.name == "InterpolationContent" ? o : null)
  ...
  top: "Attribute"
}), E = { parser: U }, N = { parser: y }, l = /* @__PURE__ */ c();
function S(O) {
  return O.configure({ wrap: s(z) }, "angular");
}
const k = /* @__PURE__ */ S(l.language);
function z(O, t) {
  switch (O.name) {
    case "Attribute":
...
function X(O = {}) {
  ...
  return new q(t.language == l.language ? k : S(t.language), [t.support, t.language.data.of({
