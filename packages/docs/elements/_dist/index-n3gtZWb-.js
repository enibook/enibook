import { E as R, C as z, L as G } from "./index-r15drT3X.js";
import { s as w, t as $, L as q, f as p, j as b, b as v, d as u, a as E } from "./enibook-UgUmBc-f.js";
import { defineCSSCompletionSource as C } from "./index-1dS7qubp.js";
...
const nO = new R((O, e) => {
  if (e.dialectEnabled(c)) {
    let a;
    if (O.next < 0 && e.canShift(_))
      O.acceptToken(_);
    else if (((a = O.peek(-1)) == t || a < 0) && e.canShift(Z)) {
      let Q = 0;
      for (; O.next != t && o.includes(O.next); )
        O.advance(), Q++;
      O.next == t || y(O) ? O.acceptToken(Z, -Q) : Q && O.acceptToken(P);
    } else if (O.next == t)
      O.acceptToken(K, 1);
  ...
  for (let a = !1, Q = 0, n = 0; ; n++) {
    ...
    if (d(i) || i == l || i == f || a && g(i))
      ...
      a && O.acceptToken(i == M ? I : Q == 2 && e.canShift(k) ? k : D);
      break;
    }
  }
}), lO = new R((O) => {
...
const SO = new W(null, 0), cO = new z({
  ...
  "[ ]": $.squareBracket,
  "{ }": $.brace
}), XO = { __proto__: null, not: 62, only: 62, using: 173, with: 183, without: 183, hide: 197, show: 197, from: 220, to: 222, if: 235, through: 241, in: 247 }, sO = { __proto__: null, url: 80, "url-prefix": 80, domain: 80, regexp: 80, lang: 94, "nth-child": 94, "nth-last-child": 94, "nth-of-type": 94, "nth-last-of-type": 94, dir: 94, "host-context": 94, selector: 166 }, fO = { __proto__: null, "@import": 150, "@include": 170, "@mixin": 176, "@function": 176, "@use": 180, "@extend": 186, "@at-root": 190, "@forward": 194, "@media": 200, "@charset": 204, "@namespace": 208, "@keyframes": 214, "@supports": 226, "@if": 230, "@else": 232, "@for": 238, "@each": 244, "@while": 250, "@debug": 254, "@warn": 254, "@error": 254, "@return": 254 }, mO = G.deserialize({
  version: 14,
...
}), TO = /* @__PURE__ */ C((O) => O.name == "VariableName" || O.name == "SassVariableName");
function hO(O) {
  return new E(O != null && O.indented ? yO : s, s.data.of({ autocomplete: TO }));
}
export {
  hO as sass,
