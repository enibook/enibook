import { a as r, i, c as n, b as $, e as y, h as P, g as X, s as m, t as O, L as c, E as S } from "./enibook-uiH8CL3S.js";
...
const W = /* @__PURE__ */ new S((T, Q) => {
  ...
  "[ ]": O.squareBracket,
  "{ }": O.brace
}), h = { __proto__: null, lang: 40, "nth-child": 40, "nth-last-child": 40, "nth-of-type": 40, "nth-last-of-type": 40, dir: 40, "host-context": 40, and: 244, or: 244, not: 74, only: 74, url: 86, "url-prefix": 86, domain: 86, regexp: 86, when: 117, selector: 142, from: 172, to: 174 }, z = { __proto__: null, "@import": 126, "@plugin": 126, "@media": 152, "@charset": 156, "@namespace": 160, "@keyframes": 166, "@supports": 178 }, g = /* @__PURE__ */ c.deserialize({
  version: 14,
  ...
  specialized: [{ term: 116, get: (T) => h[T] || -1 }, { term: 23, get: (T) => z[T] || -1 }],
  tokenPrec: 2180
}), o = /* @__PURE__ */ r.define({
  name: "less",
...
}), u = /* @__PURE__ */ P((T) => T.name == "VariableName" || T.name == "AtKeyword");
function R() {
  return new X(o, o.data.of({ autocomplete: u }));
}
export {
  R as less,
