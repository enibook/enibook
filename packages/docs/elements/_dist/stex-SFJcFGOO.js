function k(b) {
  ...
  function l(t, n) {
    ...
    if (u == "}" || u == "]") {
      ...
      return u == "{" || u == "[" ? (e = r.DEFAULT, e = new e(), h(n, e), "bracket") : /\d/.test(u) ? (t.eatWhile(/[\w.%]/), "atom") : (t.eatWhile(/[\w\-_]/), e = s(n), e.name == "begin" && (e.argument = t.current()), e.styleIdentifier());
  }
  function o(t, n, e) {
    if (t.eatSpace())
      return null;
  ...
  function d(t, n) {
    var e = t.peek(), a;
    return e == "{" || e == "[" ? (a = g(n), a.openBracket(e), t.eat(e), f(n, l), "bracket") : /[ \t\r]/.test(e) ? (t.eat(e), null) : (f(n, l), p(n), l(t, n));
  }
  return {
    name: "stex",
    startState: function() {
