...
const g = {
  ...
  token: function(e, n) {
    ...
    if (t != "comment" && n.context && n.context.align == null && n.context.type != "pattern" && (n.context.align = !0), r == "(")
      ...
      for (; n.context && n.context.type == "pattern"; )
        c(n);
      n.context && r == n.context.type && c(n);
    } else
      r == "." && n.context && n.context.type == "pattern" ? c(n) : /atom|string|variable/.test(t) && n.context && (/[\}\]]/.test(n.context.type) ? l(n, "pattern", e.column()) : n.context.type == "pattern" && !n.context.align && (n.context.align = !0, n.context.col = e.column()));
    return t;
  },
