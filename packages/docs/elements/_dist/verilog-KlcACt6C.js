function A(i) {
  ...
  return {
    ...
    indent: function(e, n, t) {
      if (e.tokenize != _ && e.tokenize != null)
        return null;
      if (a.indent) {
        var r = a.indent(e);
        if (r >= 0)
      ...
      if (o.tlvCodeActive) {
        ...
        if (u === void 0)
          if (o.tlvInBlockComment)
            ...
            i.match(/^\t+/) ? u = "invalid" : i.match(/^[\[\]{}\(\);\:]+/) ? u = "meta" : (c = i.match(/^[mM]4([\+_])?[\w\d_]*/)) ? u = c[1] == "+" ? "keyword.special" : "keyword" : i.match(/^ +/) ? i.eol() && (u = "error") : i.match(/^[\w\d_]+/) ? u = "number" : i.next();
      } else
