...
const w = {
  ...
  token: function(e, t) {
    var n = t.context;
    if (e.sol() && (n.align == null && (n.align = !1), t.indented = e.indentation(), t.startOfLine = !0), e.eatSpace())
      return null;
    o = null;
    var r = (t.tokenize || c)(e, t);
    if (r == "comment" || r == "meta")
      return r;
    if (n.align == null && (n.align = !0), (o == ";" || o == ":") && n.type == "statement")
      u(t);
    else if (o == "{")
      a(t, e.column(), "}");
    else if (o == "[")
      ...
      for (; n.type == "statement"; )
        n = u(t);
      for (n.type == "}" && (n = u(t)); n.type == "statement"; )
        n = u(t);
    } else
      o == n.type ? u(t) : (n.type == "}" || n.type == "top" || n.type == "statement" && o == "newstatement") && a(t, e.column(), "statement");
