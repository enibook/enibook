...
<html-preview-it>
  <script type="enibook">
    <ul>
      <li>à gauche : code source;</li>
      <li>à droite : aperçu.</li>
    </ul>
  </script>
</html-preview-it>
++++
...
=== Script ``enibook``
Le code source à visualiser peut être défini en précisant le contenu de la balise ``html-preview-it`` à l'aide d'un script de type ``enibook``.
...
.Un script dans le script ``enibook``
======
...
.Codes issus d'un script et d'un fichier
====
++++
<html-preview-it>
  <script type="enibook">
