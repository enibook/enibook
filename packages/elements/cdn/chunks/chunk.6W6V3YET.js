...
var { D: t } = z;
var e3 = (o4, t3) => void 0 === t3 ? void 0 !== (o4 == null ? void 0 : o4._$litType$) : (o4 == null ? void 0 : o4._$litType$) === t3;
var f = (o4) => void 0 === o4.strings;
var u = {};
var m = (o4, t3 = u) => o4._$AH = t3;
...
var e4 = Symbol.for("");
var o = (t3) => {
  if ((t3 == null ? void 0 : t3.r) === e4)
    return t3 == null ? void 0 : t3._$litStatic$;
};
var s2 = (t3, ...r3) => ({ _$litStatic$: r3.reduce((r4, e5, o4) => r4 + ((t4) => {
...
var l = (t3) => (r3, ...e5) => {
  ...
  let c, $ = 0, f2 = false;
  for (; $ < i2; ) {
    for (c = r3[$]; $ < i2 && void 0 !== (l2 = e5[$], s3 = o(l2)); )
      c += s3 + r3[++$], f2 = true;
    $ !== i2 && u3.push(l2), n3.push(c), $++;
  }
  if ($ === i2 && n3.push(r3[i2]), f2) {
    const t4 = n3.join("$$lit$$");
    void 0 === (r3 = a.get(t4)) && (n3.raw = n3, a.set(t4, r3 = n3)), e5 = u3;
  }
  return t3(r3, ...e5);
};
var n2 = l(x);
...
function r2(t3) {
  for (let e5 = t3; e5; e5 = o3(e5))
    if (e5 instanceof Element && "none" === getComputedStyle(e5).display)
      return null;
  for (let e5 = o3(t3); e5; e5 = o3(e5)) {
    if (!(e5 instanceof Element))
      continue;
    const t4 = getComputedStyle(e5);
...
var SlPopup = class extends ShoelaceElement {
  ...
  reposition() {
    ...
    const getOffsetParent2 = this.strategy === "absolute" ? (element) => platform.getOffsetParent(element, t2) : platform.getOffsetParent;
