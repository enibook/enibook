...
var _a;
Z == null ? void 0 : Z(V, M), ((_a = t.litHtmlVersions) != null ? _a : t.litHtmlVersions = []).push("3.1.1");
var j = (t3, i4, s4) => {
  var _a6, _b2;
...
var b2 = class extends HTMLElement {
  ...
  requestUpdate(t3, s4, i4) {
    var _a6;
    if (void 0 !== t3) {
      if (i4 != null ? i4 : i4 = this.constructor.getPropertyOptions(t3), !((_a6 = i4.hasChanged) != null ? _a6 : f2)(this[t3], s4))
        return;
      this.C(t3, s4, i4);
    }
  ...
  C(t3, s4, i4) {
    var _a6;
    this._$AL.has(t3) || this._$AL.set(t3, s4), true === i4.reflect && this._$Em !== t3 && ((_a6 = this._$ET) != null ? _a6 : this._$ET = /* @__PURE__ */ new Set()).add(t3);
  }
  async _$EP() {
  ...
  performUpdate() {
    ...
    try {
      ...
      }), this.update(s4)) : this._$Ej();
    } catch (s5) {
      throw t3 = false, this._$Ej(), s5;
    }
    t3 && this._$AE(s4);
  }
  willUpdate(t3) {
  ...
  update(t3) {
    this._$ET && (this._$ET = this._$ET.forEach((t4) => this._$EO(t4, this[t4]))), this._$Ej();
  }
  updated(t3) {
  }
  firstUpdated(t3) {
...
var _a3;
b2.elementStyles = [], b2.shadowRootOptions = { mode: "open" }, b2[d2("elementProperties")] = /* @__PURE__ */ new Map(), b2[d2("finalized")] = /* @__PURE__ */ new Map(), p2 == null ? void 0 : p2({ ReactiveElement: b2 }), ((_a3 = a2.reactiveElementVersions) != null ? _a3 : a2.reactiveElementVersions = []).push("2.0.3");
...
var _a5;
((_a5 = globalThis.litElementVersions) != null ? _a5 : globalThis.litElementVersions = []).push("4.0.3");
