...
function N(t4, i5, s4 = t4, e6) {
  ...
  return h3?.constructor !== o5 && (h3?._$AO?.(false), void 0 === o5 ? h3 = void 0 : (h3 = new o5(t4), h3._$AT(t4, s4, e6)), void 0 !== e6 ? (s4._$Co ?? (s4._$Co = []))[e6] = h3 : s4._$Cl = h3), void 0 !== h3 && (i5 = N(t4, h3._$AS(t4, i5.values), h3, e6)), i5;
}
var S2 = class {
  constructor(t4, i5) {
...
var M = class _M {
  ...
  constructor(t4, i5, s4, e6) {
    this.type = 2, this._$AH = T, this._$AN = void 0, this._$AA = t4, this._$AB = i5, this._$AM = s4, this.options = e6, this._$Cv = e6?.isConnected ?? true;
  }
  get parentNode() {
  ...
  _$AI(t4, i5 = this, s4, e6) {
    ...
    if (void 0 === h3)
      ...
      for (t4 = h3[0], n4 = 0; n4 < h3.length - 1; n4++)
        r5 = N(this, e7[s4 + n4], i5, n4), r5 === w && (r5 = this._$AH[n4]), o5 || (o5 = !c3(r5) || r5 !== this._$AH[n4]), r5 === T ? t4 = T : t4 !== T && (t4 += (r5 ?? "") + h3[n4 + 1]), this._$AH[n4] = r5;
    }
    o5 && !e6 && this.j(t4);
  }
  j(t4) {
...
Z?.(V, M), (t2.litHtmlVersions ?? (t2.litHtmlVersions = [])).push("3.1.2");
var j = (t4, i5, s4) => {
  const e6 = s4?.renderBefore ?? i5;
  let h3 = e6._$litPart$;
  if (void 0 === h3) {
    const t5 = s4?.renderBefore ?? null;
    e6._$litPart$ = h3 = new M(i5.insertBefore(l2(), t5), t5, void 0, s4 ?? {});
  }
