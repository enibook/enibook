...
function n(t3) {
  return (e4, o2) => "object" == typeof o2 ? r(t3, e4, o2) : ((t4, e5, o3) => {
    ...
    return e5.constructor.createProperty(o3, r4 ? { ...t4, wrapped: true } : t4), r4 ? Object.getOwnPropertyDescriptor(e5, o3) : void 0;
  })(t3, e4, o2);
}
...
function e2(e4, r4) {
  return (n2, s2, i2) => {
    const o2 = (t3) => t3.renderRoot?.querySelector(e4) ?? null;
    if (r4) {
      const { get: e5, set: r5 } = "object" == typeof s2 ? n2 : i2 ?? (() => {
        const t3 = Symbol();
        return { get() {
          return this[t3];
        }, set(e6) {
...
function r3(r4) {
  return (n2, o2) => e(n2, o2, { get() {
    return (this.renderRoot ?? (e3 ?? (e3 = document.createDocumentFragment()))).querySelectorAll(r4);
  } });
}
