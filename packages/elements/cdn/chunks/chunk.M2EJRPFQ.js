...
// ../../node_modules/.pnpm/@codemirror+search@6.5.5/node_modules/@codemirror/search/dist/index.js
  ...
  keymap.forEach((map) => {
    ...
    if ((map.key || map.mac) && map.run && map.run.name) {
      if (map.mac) {
        ...
        if ((_a = map.shift) == null ? void 0 : _a.name) {
        ...
        if (map.key && !map.mac) {
          ...
          if ((_b = map.shift) == null ? void 0 : _b.name) {
