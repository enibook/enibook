...
import {
  templateHTML
} from "./chunk.3FIH6XU6.js";
import {
  darkTheme
} from "./chunk.CIJWEKAO.js";
import {
  lightTheme
      ...
      <div part="base" class=${e2(classes)}>
        ...
        <div class="editor-base">
          ...
          <div part="menuBtn" class="menu-button">
            ...
            ${this.btnFeedback ? this.renderFeedbackButton() : x``}
          </div>
        </div>
...
__decorateClass([
  n({ type: String, reflect: true })
], CodeIt.prototype, "srcHead", 2);
__decorateClass([
  n({ type: String, reflect: true })
], CodeIt.prototype, "srcHeader", 2);
__decorateClass([
  n({ type: String, reflect: true })
], CodeIt.prototype, "srcFooter", 2);
__decorateClass([
  n({ type: String, reflect: true })
