...
var s2 = (t2, ...r2) => ({ _$litStatic$: r2.reduce((r3, e5, o3) => r3 + ((t3) => {
...
var l = (t2) => (r2, ...e5) => {
  ...
  let c, $ = 0, f2 = false;
  for (; $ < i2; ) {
    for (c = r2[$]; $ < i2 && void 0 !== (l2 = e5[$], s3 = o(l2)); )
      c += s3 + r2[++$], f2 = true;
    $ !== i2 && u3.push(l2), n3.push(c), $++;
  }
  if ($ === i2 && n3.push(r2[i2]), f2) {
    const t3 = n3.join("$$lit$$");
    void 0 === (r2 = a.get(t3)) && (n3.raw = n3, a.set(t3, r2 = n3)), e5 = u3;
  }
  return t2(r2, ...e5);
};
var n2 = l(x);
